 ...
 *
 */
public class FiatTestProcessPgmLevelTest implements AmritaConstants {
	 ...
	 */
	@Test
	public final void testFiatProcessPgmlevel() throws Exception {
		aps = new ExecutionStarter();
		arParm = new String[2];
		arParm[0] = "";     // File di configurazione di default
		arParm[1] = "PilotFiatProcessPgmlevel.pilot";   // File pilota per Fiat processi a livello programma  
		aps.main(arParm);
		assertTrue(true);
