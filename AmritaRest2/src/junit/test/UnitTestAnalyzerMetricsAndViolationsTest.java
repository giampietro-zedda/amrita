 ...
 *
 */
public class UnitTestAnalyzerMetricsAndViolationsTest implements AmritaConstants {
	 ...
	 */
	@Test
	public final void testAnalyzerMetricsAndViolations() throws Exception {
		aps = new ExecutionStarter();
		arParm = new String[2];
		arParm[0] = "";     // File di configurazione di default
		arParm[1] = "PilotUnitTestAnalyzerMetricsAndViolations.pilot";   // File pilota per Fiat processi
