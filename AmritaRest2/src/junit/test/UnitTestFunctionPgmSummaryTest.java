 ...
 *
 */
public class UnitTestFunctionPgmSummaryTest {
	 ...
	 */
	@Test
	public final void testFunctionPgmSummary() throws Exception {
		aps = new ExecutionStarter();
		arParm = new String[2];
		arParm[0] = "";     // File di configurazione di default
		arParm[1] = "PilotUnitTestFunctionPgmSummary.pilot";   // File pilota per unit test analyzer cobol
		aps.main(arParm);
		assertTrue(true);
	}
