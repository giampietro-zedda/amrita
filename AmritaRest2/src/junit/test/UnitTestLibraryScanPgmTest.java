 ...
 *
 */
public class UnitTestLibraryScanPgmTest {
	 ...
	 */
	@Test
	public final void testLibraryScan() throws Exception {
		aps = new ExecutionStarter();
		arParm = new String[2];  
		arParm[0] = "";     // File di configurazione di default
 //    	arParm[1] = "PilotAcquireUx10100.pilot";   // File pilota per unit test analyzer cobol
  		arParm[1] = "PilotUnitTestLibraryScanPgm.pilot";   // File pilota per unit test analyzer cobol
		aps.main(arParm);
		assertTrue(true);
	} 
