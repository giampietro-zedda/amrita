 ...
 *
 */
public class FiatLibraryScanPgmTest implements AmritaConstants {
     ...
     protected UserConfiguration di = null;
	 ...
	 */
	@Test
	public final void testFiatLibraryScanPgm() throws Exception {
		aps = new ExecutionStarter();
		arParm = new String[2];
		arParm[0] = "";     // File di configurazione di default
		arParm[1] = "PilotFiatLibraryScanPgm.pilot";        // File pilota per test libraryScan
