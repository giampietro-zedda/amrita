 ...
 *
 */
public class LibraryScanAssegniTest {
	...
	public final void testFunctionSourcesDetected() throws Exception {
		...
		arParm[1] = "PilotLibraryScanAssegniFull.pilot";   // File pilota processi San Paolo ASSEGNI
		arParm[1] = "PilotLibraryScanAssegniShort.pilot";   // File pilota processi San Paolo ASSEGNI
		aps.main(arParm);
		assertTrue(true);
	}
