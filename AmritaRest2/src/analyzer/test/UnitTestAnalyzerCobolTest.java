 ...
 *
 */
public class UnitTestAnalyzerCobolTest {
	 ...
	 */
	@Test
	public final void testAnalyzerCobol() throws Exception {
		aps = new ExecutionStarter();
		arParm = new String[2];
		arParm[0] = "";     // File di configurazione di default
		arParm[1] = "PilotTestUX10100.pilot";   			// File pilota per unit test analyzer cobol
		arParm[1] = "PilotUnitTestAnalyzerCobol.pilot";     // File pilota per unit test analyzer cobol
		aps.main(arParm);
		assertTrue(true);
	}
