 ...
 *
 */
public class FiatTestProcessSystemLevelTest implements AmritaConstants {
	 ...
	 */
	@Test
	public final void testFiatProcessSystemLevel() throws Exception {
		aps = new ExecutionStarter();
		arParm = new String[2];
		arParm[0] = "";     // File di configurazione di default
		arParm[1] = "PilotFiatProcessSystemlevel.pilot";   // File pilota Fiat per processi a livello programma
		aps.main(arParm);
		assertTrue(true);
	}
