 ...
 */
public class DAOImplObjectAnalysisInfo extends DAOAbstract<EntityObjectAnalysisInfo> implements IDAOObjectAnalysisInfo{

	/*
	 * Constructor 
	 */
	public DAOImplObjectAnalysisInfo(boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
		super(isConnToClose, isAutocommit);
		super.typeClass = EntityObjectAnalysisInfo.class;
		super.ucfg = ucfg;
	}
	 ...
	 * Constructor 
	 */
	public DAOImplObjectAnalysisInfo(Connection conn, boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
	...
	/* (non-Javadoc)
	 * @see dao.IDAOObjectAnalysisInfo#findAll(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	public List<EntityObjectAnalysisInfo> findAll(String sys, String subSys, String idObject) throws SQLException, ExceptionAmritaSqlError {
	    ...
	    String FIND_ALL_WHERE = ""
				...
				+"  AND idObject = ? "  
				;
	   return super.readSetEntityParmAbstract(FIND_ALL_WHERE, sys, subSys, idObject);	
	}

	/* (non-Javadoc)
	 * @see dao.IDAOObjectAnalysisInfo#findAll(java.lang.String, java.lang.String)
	 */
	@Override
	 ...
	 */
	public List<EntityObjectAnalysisInfo> findAllWhere(String whereClause, String orderBy) throws ExceptionAmritaSqlError, SQLException {
	 ...
	 */
	@Override
	public List<EntityObjectAnalysisInfo> readSetEntityParm(String where, Object... parms) throws SQLException, ExceptionAmritaSqlError {
	 ...
	 */
	@Override
	public List<EntityObjectAnalysisInfo> readSetEntityWhere(String where, String orderBy) throws SQLException, ExceptionAmritaSqlError {
	...
	@Override
	public List<EntityObjectAnalysisInfo> execSqlGenericEntity(String strSql, Object... parms) throws SQLException, ExceptionAmritaSqlError {
