 ...
 */
public class DAOImplMetricViolation extends DAOAbstract<EntityMetricViolation> implements IDAOMetricViolation{

	/*
	 * Constructor 
	 */
	public DAOImplMetricViolation(boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
		super(isConnToClose, isAutocommit);
		super.typeClass = EntityMetricViolation.class;
		super.ucfg = ucfg;
	}
	 ...
	 * Constructor 
	 */
	public DAOImplMetricViolation(Connection conn, boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
	 ...
	 */
	@Override
	public List<EntityMetricViolation> findAll(String sys, String subSys, EnumMetricsScope scope, String idObject,
			EnumObject typeObject, String section, EnumMetricsViolation typeViolation) throws SQLException, ExceptionAmritaSqlError {
	    String FIND_ALL_WHERE = ""
				...
				+"  AND typeObject = ? "  				
				+"  AND section = ? "  
				+"ORDER BY typeViolation ASC "  
				;
		   return super.readSetEntityParmAbstract(FIND_ALL_WHERE, sys, subSys, scope, idObject, typeObject, section);	
	}

	/* (non-Javadoc)
	 * @see dao.IDAOMetricViolation#findAll(java.lang.String, java.lang.String, enums.EnumMetricsScope, java.lang.String, enums.EnumObject)
	 */
	@Override
	public List<EntityMetricViolation> findAll(String sys, String subSys, EnumMetricsScope scope, String idObject,
			EnumObject typeObject) throws SQLException, ExceptionAmritaSqlError {
	    String FIND_ALL_WHERE = ""
				+"WHERE"	
				+"      sys = ? "
				+"  AND subSys = ? "
				...
				+"  AND idObject = ? "  
				+"  AND typeObject = ? "  				
				+"ORDER BY section ASC, typeViolation ASC "  
				;
		   return super.readSetEntityParmAbstract(FIND_ALL_WHERE, sys, subSys, scope, idObject, typeObject);	
	}

	/* (non-Javadoc)
	 * @see dao.IDAOMetricViolation#findAll(java.lang.String, java.lang.String)
	 */
	@Override
	public List<EntityMetricViolation> findAll(String sys, String subSys, EnumMetricsScope scope) throws SQLException, ExceptionAmritaSqlError {
	    String FIND_ALL_WHERE = ""
				...
				+"  AND subSys = ? "
				+"  AND scope = ? "  
				+"ORDER BY idObject ASC, section ASC, typeViolation ASC "  
				;
		   return super.readSetEntityParmAbstract(FIND_ALL_WHERE, sys, subSys, scope);	
	}

	/* (non-Javadoc)
	 * @see dao.IDAOMetricViolation#findAll(java.lang.String, java.lang.String, java.lang.String, enums.EnumObject)
	 */
	@Override
	public List<EntityMetricViolation> findAll(String sys, String subSys, String idObject, EnumObject typeObject)
		...
		+"  AND idObject = ? "
		+"  AND typeObject = ? "  
		+"ORDER BY idObject ASC, scope ASC, section ASC, typeViolation ASC "  
		;
   return super.readSetEntityParmAbstract(FIND_ALL_WHERE, sys, subSys, idObject, typeObject);	
	...
	/* (non-Javadoc)
	 * @see dao.IDAOMetricViolation#findAll(java.lang.String, enums.EnumMetricsScope)
	 */
	@Override
	 ...
	 */
	public List<EntityMetricViolation> findAllWhere(String whereClause, String orderBy) throws ExceptionAmritaSqlError, SQLException {
	 ...
	 */
	@Override
	public List<EntityMetricViolation> readSetEntityParm(String where, Object... parms) throws SQLException, ExceptionAmritaSqlError {
	 ...
	 */
	@Override
	public List<EntityMetricViolation> readSetEntityWhere(String where, String orderBy) throws SQLException, ExceptionAmritaSqlError {
	...
	@Override
	public List<EntityMetricViolation> execSqlGenericEntity(String strSql, Object... parms) throws SQLException, ExceptionAmritaSqlError {
