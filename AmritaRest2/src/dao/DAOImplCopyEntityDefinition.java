 ...
 */
public class DAOImplCopyEntityDefinition extends DAOAbstract<EntityCopyEntityDefinition> implements IDAOCopyEntityDefinition{
	
	/*
	 * Constructor 
	 */
	public DAOImplCopyEntityDefinition(boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
		super(isConnToClose, isAutocommit);
		super.typeClass = EntityCopyEntityDefinition.class;
		super.ucfg = ucfg;
	}
	 ...
	 * Constructor 
	 */
	public DAOImplCopyEntityDefinition(Connection conn, boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
	 ...
	 */
	public List<EntityCopyEntityDefinition> findAllWhere(String whereClause, String orderBy) throws ExceptionAmritaSqlError, SQLException {
	 ...
	 */
	@Override
	public List<EntityCopyEntityDefinition> readSetEntityParm(String where, Object... parms) throws SQLException, ExceptionAmritaSqlError {
	 ...
	 */
	@Override
	public List<EntityCopyEntityDefinition> readSetEntityWhere(String where, String orderBy) throws SQLException, ExceptionAmritaSqlError {
	...
	@Override
	public List<EntityCopyEntityDefinition> execSqlGenericEntity(String strSql, Object... parms) throws SQLException, ExceptionAmritaSqlError {
