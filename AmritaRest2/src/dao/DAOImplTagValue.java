 ...
 */
public class DAOImplTagValue extends DAOAbstract<EntityTagValue> implements IDAOTagValue{
	
	/*
	 * Constructor 
	 */
	public DAOImplTagValue(boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
		super(isConnToClose, isAutocommit);
		super.typeClass = EntityTagValue.class;
		super.ucfg = ucfg;
	}
	 ...
	 * Constructor 
	 */
	public DAOImplTagValue(Connection conn, boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
	...
	public List<EntityTagValue> findAll(String sys, String subSys, String idObject, EnumObject typeObject, int progr) throws SQLException, ExceptionAmritaSqlError {
		...
		String FIND_ALL_WHERE = ""
				...
				+"  AND progr = ? " 
				;
		return super.readSetEntityParmAbstract(FIND_ALL_WHERE, sys, subSys, idObject,  typeObject, progr);	
	}
	 ...
	 */
	public List<EntityTagValue> findAllWhere(String whereClause, String orderBy) throws ExceptionAmritaSqlError, SQLException {
	 ...
	 */
	@Override
	public List<EntityTagValue> readSetEntityParm(String where, Object... parms) throws SQLException, ExceptionAmritaSqlError {
	 ...
	 */
	@Override
	public List<EntityTagValue> readSetEntityWhere(String where, String orderBy) throws SQLException, ExceptionAmritaSqlError {
	...
	@Override
	public List<EntityTagValue> execSqlGenericEntity(String strSql, Object... parms) throws SQLException, ExceptionAmritaSqlError {
