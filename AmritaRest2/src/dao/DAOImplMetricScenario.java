 ...
 */
public class DAOImplMetricScenario extends DAOAbstract<EntityMetricScenario> implements IDAOMetricScenario{

	/*
	 * Constructor 
	 */
	public DAOImplMetricScenario(boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
		super(isConnToClose, isAutocommit);
		super.typeClass = EntityMetricScenario.class;
		super.ucfg = ucfg;
	}
	 ...
	 * Constructor 
	 */
	public DAOImplMetricScenario(Connection conn, boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
	...
	public List<EntityMetricScenario> findAll(String idScenario, EnumMetricsViolation typeViolation) throws SQLException, ExceptionAmritaSqlError {
	    String FIND_ALL_WHERE = ""
				...
				+"  AND typeViolation = ? "  				
				;
	   return super.readSetEntityParmAbstract(FIND_ALL_WHERE, idScenario, typeViolation);	
	}
	...
	public List<EntityMetricScenario> findAll(String idScenario) throws SQLException, ExceptionAmritaSqlError {
		...
		;
        return super.readSetEntityParmAbstract(FIND_ALL_WHERE, idScenario);	
	}
	 ...
	 */
	public List<EntityMetricScenario> findAllWhere(String whereClause, String orderBy) throws ExceptionAmritaSqlError, SQLException {
	 ...
	 */
	@Override
	public List<EntityMetricScenario> readSetEntityParm(String where, Object... parms) throws SQLException, ExceptionAmritaSqlError {
	 ...
	 */
	@Override
	public List<EntityMetricScenario> readSetEntityWhere(String where, String orderBy) throws SQLException, ExceptionAmritaSqlError {
	...
	@Override
	public List<EntityMetricScenario> execSqlGenericEntity(String strSql, Object... parms) throws SQLException, ExceptionAmritaSqlError {
