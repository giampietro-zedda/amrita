 ...
 */
public class DAOImplDynamicField extends DAOAbstract<EntityDynamicField> implements IDAODynamicField{
	
	/*
	 * Constructor 
	 */
	public DAOImplDynamicField(boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
		super(isConnToClose, isAutocommit);
		super.typeClass = EntityDynamicField.class;
		super.ucfg = ucfg;
	}
	 ...
	 * Constructor 
	 */
	public DAOImplDynamicField(Connection conn, boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
	...
	public List<EntityDynamicField> findAll(String sys, String subSys, String idObject, EnumObject typeObject, int numInstr, String idField) throws SQLException, ExceptionAmritaSqlError {
		...
		//  Find dynamicField list by full key 
		String FIND_ALL_WHERE = ""
				...
				+"  AND numInstr = ? " 
				+"  AND idField = ? " 
				+"ORDER BY numseq ASC, idField ASC"
				;
	 ...
	 * @see dao.IDAODynamicField#findAll(java.lang.String, java.lang.String, java.lang.String, enums.EnumObject)
	 */
	@Override
	public List<EntityDynamicField> findAll(String sys, String subSys, String idObject, EnumObject typeObject) throws SQLException, ExceptionAmritaSqlError {
	    ...
	    //  Find dynamicField list by subSys, idObject
		String FIND_ALL_WHERE = ""
				+"WHERE "	
				+"      sys = ? "
				+"  AND subSys = ? "	
				+"  AND idObject = ? "  
				+"  AND typeObject = ? "  
				+"ORDER BY numInstr ASC, idField ASC"
				;
	 ...
	 * @see dao.IDAODynamicField#findAll(java.lang.String, java.lang.String, java.lang.String, enums.EnumObject, java.lang.String)
	 */
	@Override
	public List<EntityDynamicField> findAll(String sys, String subSys, String idObject, EnumObject typeObject, String idField) throws SQLException, ExceptionAmritaSqlError {
	    ...
	    //  Find dynamicField list by subSys, idObject, idField
		String FIND_ALL_WHERE = ""
				+"WHERE "	
				+"      sys = ? "
				+"  AND subSys = ? "	
	 ...
	 * @see dao.IDAODynamicField#findAll(java.lang.String, java.lang.String, java.lang.String, enums.EnumObject, int)
	 */
	@Override
	public List<EntityDynamicField> findAll(String sys, String subSys, String idObject, EnumObject typeObject, int numInstr) throws SQLException, ExceptionAmritaSqlError {
	    ...
	    //  Find dynamicField list by subSys, idObject, numInstr
		String FIND_ALL_WHERE = ""
				+"WHERE "	
				+"      sys = ? "
				+"  AND subSys = ? "	
	 ...
	 * @see dao.IDAODynamicField#findAll(java.lang.String, java.lang.String)
	 */
	@Override
	 ...
	 */
	public List<EntityDynamicField> findAllWhere(String whereClause, String orderBy) throws ExceptionAmritaSqlError, SQLException {
	 ...
	 */
	@Override
	public List<EntityDynamicField> readSetEntityParm(String where, Object... parms) throws SQLException, ExceptionAmritaSqlError {
	 ...
	 */
	@Override
	public List<EntityDynamicField> readSetEntityWhere(String where, String orderBy) throws SQLException, ExceptionAmritaSqlError {
	...
	@Override
	public List<EntityDynamicField> execSqlGenericEntity(String strSql, Object... parms) throws SQLException, ExceptionAmritaSqlError {
