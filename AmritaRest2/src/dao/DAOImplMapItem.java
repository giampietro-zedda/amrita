 ...
 */
public class DAOImplMapItem extends DAOAbstract<EntityMapItem> implements IDAOMapItem {
	/*
	 * Constructor 
	 */
	public DAOImplMapItem(boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
		super(isConnToClose, isAutocommit);
		super.typeClass = EntityMapItem.class;
		super.ucfg = ucfg;
	}
	 ...
	 * Constructor 
	 */
	public DAOImplMapItem(Connection conn, boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
	 ...
	 * 
	 * Get all objects by a Select instruction, with specific where condition supplied, with result a List<EntityMapItem>
	 ...
	 */
	public List<EntityMapItem> findAllWhere(String whereClause, String orderBy) throws ExceptionAmritaSqlError, SQLException {
	 ...
	 * @throws ExceptionAmrita 
	 */
	public List<EntityMapItem> readSetEntityParm(String where, Object... parms) throws SQLException, ExceptionAmritaSqlError {
	 ...
	 * @throws ExceptionAmrita 
	 */
	public List<EntityMapItem> readSetEntityWhere(String where, String orderBy) throws SQLException, ExceptionAmritaSqlError {
	...
	public List<EntityMapItem> execSqlGenericEntity(String strSql, Object... parms) throws SQLException, ExceptionAmritaSqlError {
