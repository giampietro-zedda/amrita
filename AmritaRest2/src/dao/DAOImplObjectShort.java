 ...
 */
public class DAOImplObjectShort extends DAOAbstract<EntityObjectShort> {

	/*
	 * Constructor
	 */
	public DAOImplObjectShort(boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
		super(isConnToClose, isAutocommit);
		super.typeClass = EntityObjectShort.class;
		super.ucfg = ucfg;
	}
	 ...
	 * Constructor
	 */
	public DAOImplObjectShort(Connection conn, boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
	...
	/*
	 * 1 Get all Object of the type and status specified (i.e. COBOL_PROGRAM &
	 * ANALYZED_WITH_NO_ERRORS)
	 */
	public List<EntityObjectShort> findAll(String sys, EnumObject typeObject, EnumObjectStatus statusObject) throws SQLException, ExceptionAmritaSqlError {
	...
	/*
	 * 2 Get all Object of the type and status specified (i.e. COBOL_PROGRAM &
	 * ANALYZED_WITH_NO_ERRORS)
	 */
	public List<EntityObjectShort> findAll(String sys, String subSys, EnumObject typeObject, EnumObjectStatus statusObject) throws SQLException, ExceptionAmritaSqlError {
		// Find object list by type and status
		String FIND_ALL_WHERE = "" 
	 ...
	 */
	public List<EntityObjectShort> findAll(String sys, EnumObjectStatus status) throws SQLException, ExceptionAmritaSqlError {
	...
	/*
	 * 4 Get all Object with with subsys and type regardless status  
	 */
	public List<EntityObjectShort> findAll(String sys, String subSys, EnumObject typeObject) throws SQLException, ExceptionAmritaSqlError {
		// Find object list by status
		String FIND_ALL_WHERE = "" 
				+ "WHERE" + "     sys = ? " + " AND subSys = ? " + " AND typeObject = ? "
	 ...
	 */
	public List<EntityObjectShort> findAllWhere(String whereClause, String orderBy) throws ExceptionAmritaSqlError, SQLException {
	 ...
	 */
	@Override
	public List<EntityObjectShort> readSetEntityParm(String where, Object... parms) throws SQLException, ExceptionAmritaSqlError {
	 ...
	 */
	@Override
	public List<EntityObjectShort> readSetEntityWhere(String where, String orderBy) throws SQLException, ExceptionAmritaSqlError {
	...
	@Override
	public List<EntityObjectShort> execSqlGenericEntity(String strSql, Object... parms) throws SQLException, ExceptionAmritaSqlError {
