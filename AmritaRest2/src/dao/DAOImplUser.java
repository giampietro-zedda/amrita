 ...
 */
public class DAOImplUser extends DAOAbstract<EntityUser> implements IDAOUser {

	/*
	 * Constructor no conn
	 */
	public DAOImplUser(boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
		super(isConnToClose, isAutocommit);
		super.typeClass = EntityUser.class;
		super.ucfg = ucfg;
	}
	 ...
	 */
	public DAOImplUser(Connection conn, boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
	...
	public List<EntityUser> findAll() throws SQLException, ExceptionAmritaSqlError {
		...
		return super.readSetEntityParmAbstract(FIND_ALL_WHERE);
	}
	...
	public List<EntityUser> findAll(String user) throws SQLException, ExceptionAmritaSqlError {
		...
		String FIND_ALL_WHERE = "" 
				+ "WHERE" + "      user = ? " 
				+ "ORDER BY user ASC";
		return super.readSetEntityParmAbstract(FIND_ALL_WHERE, user);	}
	 ...
	 */
	public List<EntityUser> findAllWhere(String whereClause, String orderBy) throws ExceptionAmritaSqlError, SQLException {
	 ...
	 */
	@Override
	public List<EntityUser> readSetEntityParm(String where, Object... parms) throws SQLException, ExceptionAmritaSqlError {
	 ...
	 */
	@Override
	public List<EntityUser> readSetEntityWhere(String where, String orderBy) throws SQLException, ExceptionAmritaSqlError {
	...
	@Override
	public List<EntityUser> execSqlGenericEntity(String strSql, Object... parms) throws SQLException, ExceptionAmritaSqlError {
