 ...
 */
public class DAOImplObjectAnalysisError extends DAOAbstract<EntityObjectAnalysisError> implements IDAOObjectAnalysisError{

	/*
	 * Constructor 
	 */
	public DAOImplObjectAnalysisError(boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
		super(isConnToClose, isAutocommit);
		super.typeClass = EntityObjectAnalysisError.class;
		super.ucfg = ucfg;
	}
	 ...
	 * Constructor 
	 */
	public DAOImplObjectAnalysisError(Connection conn, boolean isConnToClose, boolean isAutocommit, UserConfiguration ucfg) {
	...
	/* (non-Javadoc)
	 * @see dao.IDAOObjectAnalysisError#findAll(java.lang.String, java.lang.String, java.lang.String, enums.EnumObject)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dao.IDAOObjectAnalysisError#findAll(java.lang.String, java.lang.String, java.lang.String, enums.EnumObject, int)
	 */
	@Override
	public List<EntityObjectAnalysisError> findAll(String sys, String subSys, String idObject, EnumObject typeObject, int rowNum) throws SQLException, ExceptionAmritaSqlError {
	    String FIND_ALL_WHERE = ""
				...
				+"  AND rowNum = ? "  
				;
	   return super.readSetEntityParmAbstract(FIND_ALL_WHERE, sys, subSys, idObject, typeObject, rowNum);	
	}

	/* (non-Javadoc)
	 * @see dao.IDAOObjectAnalysisError#findAll(java.lang.String, java.lang.String)
	 */
	@Override
	public List<EntityObjectAnalysisError> findAll(String sys, String subSys) throws SQLException, ExceptionAmritaSqlError {
		...
		String FIND_ALL_WHERE = ""
				...
				+"      sys = ? "
				+"  AND subSys = ? "
				+"ORDER BY idObject ASC, rowNum ASC"
				;
	   return super.readSetEntityParmAbstract(FIND_ALL_WHERE, sys, subSys);	
	}

	/* (non-Javadoc)
	 * @see dao.IDAOObjectAnalysisError#findAll(java.lang.String)
	 */
	@Override
	public List<EntityObjectAnalysisError> findAll(String sys) throws SQLException, ExceptionAmritaSqlError {
			...
			String FIND_ALL_WHERE = ""
					+"WHERE"	
					+"      sys = ? "
					+"ORDER BY subSys ASC, idObject ASC, rowNum ASC"
					;
	 ...
	 */
	public List<EntityObjectAnalysisError> findAllWhere(String whereClause, String orderBy) throws ExceptionAmritaSqlError, SQLException {
	 ...
	 */
	@Override
	public List<EntityObjectAnalysisError> readSetEntityParm(String where, Object... parms) throws SQLException, ExceptionAmritaSqlError {
	 ...
	 */
	@Override
	public List<EntityObjectAnalysisError> readSetEntityWhere(String where, String orderBy) throws SQLException, ExceptionAmritaSqlError {
	...
	@Override
	public List<EntityObjectAnalysisError> execSqlGenericEntity(String strSql, Object... parms) throws SQLException, ExceptionAmritaSqlError {
