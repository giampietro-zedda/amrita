...
public class DbManagerMySqlJDBC {
   ...
   public DbManagerMySqlJDBC(String nomeDB) { this(nomeDB, "", ""); }

   public DbManagerMySqlJDBC(String nomeDB, String nomeUtente, String pwdUtente) {
      this.nomeDB = nomeDB;
   ...
   public Vector eseguiQuery(String query) {
      ...
      try {
         ...
         System.out.println("Numero righe lette"+rs.getFetchSize());
