 ...
 *
 */
public class UnitTestForward implements AmritaConstants {   
	...
	public final void testProcessPgmlevel() throws Exception {
		...
		arParm[1] = "FwdPilotUnitTestForward.pilot";   // File pilota per unit test processi a livello programma (COBTST06)
		fms.main(arParm);
		assertTrue(true);
